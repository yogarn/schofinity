...
const { getValidate, idValidate, addValidate } = require('../middlewares/validators/resourceComment');
...
router
    ...
    .patch('/:id', authToken, idValidate, checkClassPayment, checkCommentOwnership, updateComment, cache.clear)
